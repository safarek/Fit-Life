...
public class DlgPregledPlana extends JDialog {
	...
	public static void main(String[] args) {
		try {
			DlgPregledPlana dialog = new DlgPregledPlana();
	...
	private void selectPregledPlana() {
